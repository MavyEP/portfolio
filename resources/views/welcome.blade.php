...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <main>
            <div id="autotext">
                <h1>
                    <a href="/socials"  class="typewrite" data-period="2000" data-type='[ "Hi, Im Edward.", "I am Creative.", "I Love Design.", "I Love to Develop.", "I am a full Stack Web Developer." ]'>
                      <span class="wrap textauto-colorwhite "></span>
                    </a>
                </h1>
            </div>
            <div id="rocketman">
        ...
        <script src="{{ asset('js/autotext.js')}}"></script>
        <script src="{{ asset('js/rocketman.js')}}"></script>
    </body>
</html>
